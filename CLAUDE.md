...
- **Año** ("del 2024") y **ley** ("con la ley nueva", "Ley 30225", "el TUO", "D.L. 1017"): filtran, y se anuncian ("Entendí que busca en obras · año 2024"). El botón "Quitar los filtros" los suelta.
- **Tipo de contrato** ("en obras", "en servicios"): dentro de una pregunta más larga **ordena, no filtra** (dice "las pongo primero"), porque en esta taxonomía varios temas de obras —penalidades, garantías— se usan también en contratos de bienes y servicios y filtrar dejaba fuera lo pertinente. Filtra de verdad cuando el usuario lo pide solo ("¿y en obras?") o cuando no hay texto que buscar.
...
- **Palabras mal escritas** (`cercana`): busca en el vocabulario de la bitácora una palabra con el mismo arranque (dos letras), largo casi igual y una sola letra de diferencia (dos, si la palabra tiene ocho letras o más). Así "penaliada" llega a "penalidad", pero "retener" no se convierte en "tener" ni "quitar" en "quedar". Siempre lo avisa.
- **Órdenes de la conversación:** "más" (agrega tres fichas al último resultado), "no" o "me refiero a…" (descarta la interpretación anterior y toma lo que sigue como la consulta), "quitar filtros" y "empezar de nuevo".

Después de entender, ordena por pertinencia y responde **en una sola frase** —cuántas opiniones, el tema que predomina y cuántas son del régimen anterior— seguida de **tres fichas**. Cada ficha lleva el número oficial, el régimen, la fecha y el tema, el **asunto de la opinión como título**, la consulta, por qué es pertinente, la conclusión literal (la de la primera se abre sola si es corta, hasta 700 caracteres) y tres acciones: documento oficial, página en gob.pe y **"Copiar cita"**, que pone en el portapapeles el número, la fecha, el asunto, la conclusión y el enlace, listo para pegar en un escrito. Debajo, "Ver 3 más" agrega fichas sin repetir la respuesta, y los botones para ver todo en la página o acotar. Si no hay nada, sugiere temas cercanos. La pregunta queda proyectada en la página, con el filtro "Consulta: «…»".
